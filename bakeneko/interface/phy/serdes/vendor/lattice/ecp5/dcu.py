...
class DCU(Elaboratable):
	...
	def __init__(
		...
		# DCU Channel 1
		self.i_ch1_ffc_ei_en          = Signal()   # Force rransciver electrical idle control                   # i_CH1_FFC_EI_EN
		self.i_ch1_ffc_enable_cgalign = Signal()   # Enable transciver comma aligner                            # i_CH1_FFC_ENABLE_CGALIGN
		self.i_ch1_ffc_fb_loopback    = Signal()   # FPGA bridge RX-TX loopback                                 # i_CH1_FFC_FB_LOOPBACK
		self.i_ch1_ffc_pcie_ct        = Signal()   # Request treansciver to do far-side PCIe receiver detection # i_CH1_FFC_PCIE_CT
		self.i_ch1_ffc_pcie_det_en    = Signal()   # Enable transciver PCIe receiver detection                  # i_CH1_FFC_PCIE_DET_EN
		self.i_ch1_ffc_pfifo_clr      = Signal()   # Clear SerDes bridge RX-TX parallel loopback FIFO           # i_CH1_FFC_PFIFO_CLR
		self.i_ch1_ffc_sb_pfifo_lp    = Signal()   # SerDes bridge RX-TX parallel loopback                      # i_CH1_FFC_SB_PFIFO_LP
		self.i_ch1_ffc_signal_detect  = Signal()   # Signal detected                                            # i_CH1_FFC_SIGNAL_DETECT
		self.i_ch1_hdinn              = Signal()   # Transciver RX input N                                      # i_CH1_HDINN
		self.i_ch1_hdinp              = Signal()   # Transciver RX input P                                      # i_CH1_HDINP
		self.o_ch1_ffs_ls_sync_status = Signal()   # Comma syncronization status                                # o_CH1_FFS_LS_SYNC_STATUS
		self.o_ch1_ffs_pcie_con       = Signal()   # Result of far-end PCIe receivver detection                 # o_CH1_FFS_PCIE_CON
		self.o_ch1_ffs_pcie_done      = Signal()   # Far-end PCIe recevier detection completed                  # o_CH1_FFS_PCIE_DONE
		self.o_ch1_ffs_skp_added      = Signal()   # Transciver CTC added a `SKP` character                     # o_CH1_FFS_SKP_ADDED
		self.o_ch1_ffs_skp_deleted    = Signal()   # Transciver CTC removed a `SKP` character                   # o_CH1_FFS_SKP_DELETED
		self.o_ch1_hdoutn             = Signal()   # Transciver TX output N                                     # o_CH1_HDOUTN
		self.o_ch1_hdoutp             = Signal()   # Transciver TX output P                                     # o_CH1_HDOUTP
		self.p_ch1_auto_calib_en      = Const(0)   # (DCO?) Slow calibraiton - Full                             # p_CH1_AUTO_CALIB_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_auto_facq_en       = Const(0)   # (DCO?) Fast calibration - Frquency only                    # p_CH1_AUTO_FACQ_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_band_threshold     = Const(0)   # Equalization band thresholding? (undocumented)             # p_CH1_BAND_THRESHOLD: "DONTCARE" "0d0"-"0d63"
		self.p_ch1_calib_ck_mode      = Const(0)   # DCO Calibration clock mode (div/2;bypass)                  # p_CH1_CALIB_CK_MODE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_cc_match_1         = Const(0)   # Skip character 1                                           # p_CH1_CC_MATCH_1: "DONTCARE" "0x000"-"0x3ff"
		self.p_ch1_cc_match_2         = Const(0)   # Skip character 2                                           # p_CH1_CC_MATCH_2: "DONTCARE" "0x000"-"0x3ff"
		self.p_ch1_cc_match_3         = Const(0)   # Skip character 3                                           # p_CH1_CC_MATCH_3: "DONTCARE" "0x000"-"0x3ff"
		self.p_ch1_cc_match_4         = Const(0)   # Skip character 4                                           # p_CH1_CC_MATCH_4: "DONTCARE" "0x000"-"0x3ff"
		self.p_ch1_cdr_cnt4sel        = Const(0)   # CDR count(?) 4-bit selection?                              # p_CH1_CDR_CNT4SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_cdr_cnt8sel        = Const(0)   # CDR count(?) 8-bit selection?                              # p_CH1_CDR_CNT8SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_cdr_max_rate       = Const(0)   # Max input data rate for CDR? (undocumented)                # p_CH1_CDR_MAX_RATE: "DONTCARE" "0.27"-"5"
		self.p_ch1_ctc_bypass         = Const(0)   # Bypass clock-tolerance compensation                        # p_CH1_CTC_BYPASS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_dcoatdcfg          = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOATDCFG: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_dcoatddly          = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOATDDLY: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_dcobypsatd         = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOBYPSATD: "DONTCARE" "0b0" "0b1"
		self.p_ch1_dcocaldiv          = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOCALDIV: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_dcoctlgi           = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOCTLGI: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_dcodisbdavoid      = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCODISBDAVOID: "DONTCARE" "0b0" "0b1"
		self.p_ch1_dcofltdac          = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOFLTDAC: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_dcoftnrg           = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOFTNRG: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_dcoiostune         = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOIOSTUNE: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_dcoitune           = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOITUNE: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_dcoitune4lsb       = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOITUNE4LSB: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_dcoiupdnx2         = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOIUPDNX2: "DONTCARE" "0b0" "0b1"
		self.p_ch1_dconuoflsb         = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCONUOFLSB: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_dcoscalei          = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOSCALEI: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_dcostartval        = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOSTARTVAL: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_dcostep            = Const(0)   # DCO Tuning? (undocumented)                                 # p_CH1_DCOSTEP: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_dec_bypass         = Const(0)   # Bypass channel 8b10b decoder                               # p_CH1_DEC_BYPASS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_enable_cg_align    = Const(0)   # Continuous comma alignment (only if `UC_MODE` is enabled)  # p_CH1_ENABLE_CG_ALIGN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_enc_bypass         = Const(0)   # Bypass channel 8b10b endocer                               # p_CH1_ENC_BYPASS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_ge_an_enable       = Const(0)   # Gigabit Ethernet auto negotiation                          # p_CH1_GE_AN_ENABLE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_lsm_disable        = Const(0)   # Disable RX link state machine                              # p_CH1_LSM_DISABLE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_match_2_enable     = Const(0)   # Enable 2-character skip match (`CC_MATCH[4:3]`)            # p_CH1_MATCH_2_ENABLE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_match_4_enable     = Const(0)   # Enable 4-character skip match (`CC_MATCH[4:1]`)            # p_CH1_MATCH_4_ENABLE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_min_ipg_cnt        = Const(0)   # Minimum IPG (Inter-period gap?) to enforce                 # p_CH1_MIN_IPG_CNT: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_pcie_ei_en         = Const(0)   # Enable PCIe electrical idle                                # p_CH1_PCIE_EI_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_pcie_mode          = Const(0)   # PCIe mode                                                  # p_CH1_PCIE_MODE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_pcs_det_time_sel   = Const(0)   # Connection detection time (8us;2us;4us;16us)               # p_CH1_PCS_DET_TIME_SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_pden_sel           = Const(0)   # Disable CDR phase-detector on electrical idle              # p_CH1_PDEN_SEL: "DONTCARE" "0b0" "0b1"
		self.p_ch1_prbs_enable        = Const(0)   # PRBS Test machinery? (undocumented)                        # p_CH1_PRBS_ENABLE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_prbs_lock          = Const(0)   # PRBS Test machinery? (undocumented)                        # p_CH1_PRBS_LOCK: "DONTCARE" "0b0" "0b1"
		self.p_ch1_prbs_selection     = Const(0)   # PRBS Test machinery? (undocumented)                        # p_CH1_PRBS_SELECTION: "DONTCARE" "0b0" "0b1"
		self.p_ch1_protocol           = Const(0)   # Channel protocol                                           # p_CH1_PROTOCOL: "DONTCARE" "PCIE" "GBE" "SGMII" "XAUI" "SDI" "CPRI" "JESD204" "EDP" "G8B10B" "8BSER" "10BSER"
		self.p_ch1_reg_band_offset    = Const(0)   # DCO band offset control                                    # p_CH1_REG_BAND_OFFSET: "DONTCARE" "0d0"-"0d15"
		self.p_ch1_reg_band_sel       = Const(0)   # DCO bad selection (0-63 when `AUTO_CALIB_EN`)              # p_CH1_REG_BAND_SEL: "DONTCARE" "0d0"-"0d63"
		self.p_ch1_reg_idac_en        = Const(0)   # Manual current DAC enable                                  # p_CH1_REG_IDAC_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_reg_idac_sel       = Const(0)   # Manual current DAC selection (0-1023 when `REG_IDAC_EN`)   # p_CH1_REG_IDAC_SEL: "DONTCARE" "0d0"-"0d1023"
		self.p_ch1_rio_mode           = Const(0)   # Rapid-IO Mode                                              # p_CH1_RIO_MODE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rpwdnb             = Const(0)   # Channel RX power-down                                      # p_CH1_RPWDNB: "DONTCARE" "0b0" "0b1"
		self.p_ch1_tpwdnb             = Const(0)   # Channel TX power-down                                      # p_CH1_TPWDNB: "DONTCARE" "0b0" "0b1"
		self.p_ch1_uc_mode            = Const(0)   # User-configured mode                                       # p_CH1_UC_MODE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_udf_comma_a        = Const(0)   # 8b10b comma A                                              # p_CH1_UDF_COMMA_A: "DONTCARE" "0x000"-"0x3ff"
		self.p_ch1_udf_comma_b        = Const(0)   # 8b10b comma B                                              # p_CH1_UDF_COMMA_B: "DONTCARE" "0x000"-"0x3ff"
		self.p_ch1_udf_comma_mask     = Const(0)   # 8b10b comma mask                                           # p_CH1_UDF_COMMA_MASK: "DONTCARE" "0x000"-"0x3ff"
		self.p_ch1_wa_bypass          = Const(0)   # Bypass word aligner                                        # p_CH1_WA_BYPASS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_wa_mode            = Const(0)   # Barell-shifter or Bitslip alignment mode                   # p_CH1_WA_MODE: "DONTCARE" "0b0" "0b1"

		# DCU Channle 1 - TX
		self.i_ch1_ff_tx_d            = Signal(24) # TX FIFO Data                                                                                                                   # i_CH1_FF_TX_D_0-i_CH1_FF_TX_D_23
		self.i_ch1_ff_txi_clk         = Signal()   # TX Rerfernce clock input from FPGA fabric                                                                                      # i_CH1_FF_TXI_CLK
		self.i_ch1_ffc_div11_mode_tx  = Signal()   # Enable DIV/11 TX rate                                                                                                          # i_CH1_FFC_DIV11_MODE_TX
		self.i_ch1_ffc_lane_tx_rst    = Signal()   # Async reset for DCU TX logic only                                                                                              # i_CH1_FFC_LANE_TX_RST
		self.i_ch1_ffc_ldr_core2tx_en = Signal()   # Enable low-data-rate TX serial path                                                                                            # i_CH1_FFC_LDR_CORE2TX_EN
		self.i_ch1_ffc_rate_mode_tx   = Signal()   # TX data-rate div/2                                                                                                             # i_CH1_FFC_RATE_MODE_TX
		self.i_ch1_ffc_tx_gear_mode   = Signal()   # 2:1 TX gearing mode                                                                                                            # i_CH1_FFC_TX_GEAR_MODE
		self.i_ch1_ffc_txpwdnb        = Signal()   # TX power-down                                                                                                                  # i_CH1_FFC_TXPWDNB
		self.i_ch1_ldr_core2tx        = Signal()   # Single-ended low-data-rate input from FPGA fabric to TX                                                                        # i_CH1_LDR_CORE2TX
		self.o_ch1_ff_tx_f_clk        = Signal()   # TX clock                                                                                                                       # o_CH1_FF_TX_F_CLK
		self.o_ch1_ff_tx_h_clk        = Signal()   # DIV/2 TX clock                                                                                                                 # o_CH1_FF_TX_H_CLK
		self.o_ch1_ff_tx_pclk         = Signal()   # Primary TX clock (DIV/2 when 2:1 gearing)                                                                                      # o_CH1_FF_TX_PCLK
		self.o_ch1_ffs_txfbfifo_error = Signal()   # TX FPGA bridge FIFO error                                                                                                      # o_CH1_FFS_TXFBFIFO_ERROR
		self.p_ch1_ff_tx_f_clk_dis    = Const(0)   # Disable `FF_TX_F_CLK`                                                                                                          # p_CH1_FF_TX_F_CLK_DIS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_ff_tx_h_clk_en     = Const(0)   # Enable `FF_TX_H_CLK`                                                                                                           # p_CH1_FF_TX_H_CLK_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_invert_tx          = Const(0)   # Invert channel TX P/N IO pair                                                                                                  # p_CH1_INVERT_TX: "DONTCARE" "0b0" "0b1"
		self.p_ch1_ldr_core2tx_sel    = Const(0)   # Enable low-speed TX out-of-bound signal to SerDes                                                                              # p_CH1_LDR_CORE2TX_SEL: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rate_mode_tx       = Const(0)   # Default TX data-rate div/2 mode                                                                                                # p_CH1_RATE_MODE_TX: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rterm_tx           = Const(0)   # Output Termination  (0:5k;4:75;19:50; Disabled for PCIe)                                                                       # p_CH1_RTERM_TX: "DONTCARE" "0d0"-"0d31"
		self.p_ch1_sb_bypass          = Const(0)   # Bypass SerDes TX bridge (actually neded to invert tx?)                                                                         # p_CH1_SB_BYPASS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_tdrv_dat_sel       = Const(0)   # TX driver output selection (seralizer;dr clock;loopback (data if `r2t_dat_en`, clk if `r2t_ck_en`);equalized-lb iff `eq2t_en`) # p_CH1_TDRV_DAT_SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_post_en       = Const(0)   # Enable TX post-emphasis                                                                                                        # p_CH1_TDRV_POST_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_tdrv_pre_en        = Const(0)   # Enable TX pre-emphasis                                                                                                         # p_CH1_TDRV_PRE_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_tdrv_slice0_cur    = Const(0)   # TX driver slice 0 current (100uA;200uA;300uA;400uA;500uA;600uA;700uA;800uA) (100uA~=100mV swing)                               # p_CH1_TDRV_SLICE0_CUR: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_tdrv_slice0_sel    = Const(0)   # TX driver slice 0 select (power-down;main-data;pre-data;post-data)                                                             # p_CH1_TDRV_SLICE0_SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_slice1_cur    = Const(0)   # TX driver slice 1 current (100uA;200uA;300uA;400uA;500uA;600uA;700uA;800uA) (100uA~=100mV swing)                               # p_CH1_TDRV_SLICE1_CUR: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_tdrv_slice1_sel    = Const(0)   # TX driver slice 1 select (power-down;main-data;pre-data;post-data)                                                             # p_CH1_TDRV_SLICE1_SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_slice2_cur    = Const(0)   # TX driver slice 2 current (0uA;900uA;1800uA;2700uA) (100uA~=100mV swing)                                                       # p_CH1_TDRV_SLICE2_CUR: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_slice2_sel    = Const(0)   # TX driver slice 2 select (power-down;main-data;pre-data;post-data)                                                             # p_CH1_TDRV_SLICE2_SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_slice3_cur    = Const(0)   # TX driver slice 3 current (0uA;900uA;1800uA;2700uA) (100uA~=100mV swing)                                                       # p_CH1_TDRV_SLICE3_CUR: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_slice3_sel    = Const(0)   # TX driver slice 3 select (power-down;main-data;pre-data;post-data)                                                             # p_CH1_TDRV_SLICE3_SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_slice4_cur    = Const(0)   # TX driver slice 4 current (tbd)                                                                                                # p_CH1_TDRV_SLICE4_CUR: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_slice4_sel    = Const(0)   # TX driver slice 4 select (power-down;main-data;pre-data;post-data)                                                             # p_CH1_TDRV_SLICE4_SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_slice5_cur    = Const(0)   # TX driver slice 5 current (tbd)                                                                                                # p_CH1_TDRV_SLICE5_CUR: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tdrv_slice5_sel    = Const(0)   # TX driver slice 5 select (power-down;main-data;pre-data;post-data)                                                             # p_CH1_TDRV_SLICE5_SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tx_cm_sel          = Const(0)   # TX Common-mode voltage (pd;0v6;0v55;0v5)                                                                                       # p_CH1_TX_CM_SEL: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_tx_div11_sel       = Const(0)   # Enable TX Divide-by-11 (standard SMPTE)                                                                                        # p_CH1_TX_DIV11_SEL: "DONTCARE" "0b0" "0b1"
		self.p_ch1_tx_gear_bypass     = Const(0)   # Bypass TX gearbox                                                                                                              # p_CH1_TX_GEAR_BYPASS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_tx_gear_mode       = Const(0)   # Default 2:1 TX gearing mode                                                                                                    # p_CH1_TX_GEAR_MODE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_tx_post_sign       = Const(0)   # TX post-emphasis inversion                                                                                                     # p_CH1_TX_POST_SIGN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_tx_pre_sign        = Const(0)   # TX pre-emphasis inversion                                                                                                      # p_CH1_TX_PRE_SIGN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_txamplitude        = Const(0)   # Power calibaration for TX Amplitude? (undocumented)                                                                            # p_CH1_TXAMPLITUDE: "DONTCARE" "0d0"-"0d1300"
		self.p_ch1_txdepost           = Const(0)   # Power calibaration for TX pre-emphesis? (undocumented)                                                                         # p_CH1_TXDEPOST: "DONTCARE" "DISABLED" "0d0"-"0d11"
		self.p_ch1_txdepre            = Const(0)   # Power calibaration for TX post-emphesis? (undocumented)                                                                        # p_CH1_TXDEPRE: "DONTCARE" "DISABLED" "0d0"-"0d11"

		# DCU Channel 1 - RX
		self.i_ch1_ff_ebrd_clk        = Signal()   # RX CTC FIFO clock from FPGA fabric                              # i_CH1_FF_EBRD_CLK
		self.i_ch1_ff_rxi_clk         = Signal()   # RX Reference clock input from FPGA fabric                       # i_CH1_FF_RXI_CLK
		self.i_ch1_ffc_cdr_en_bitslip = Signal()   # Enable CDR bitlip? (undocumented)                               # i_CH1_FFC_CDR_EN_BITSLIP
		self.i_ch1_ffc_div11_mode_rx  = Signal()   # Enable DIV/11 RX rate                                           # i_CH1_FFC_DIV11_MODE_RX
		self.i_ch1_ffc_lane_rx_rst    = Signal()   # Async reset for DCU RX logic only                               # i_CH1_FFC_LANE_RX_RST
		self.i_ch1_ffc_rate_mode_rx   = Signal()   # RX data-rate div/2                                              # i_CH1_FFC_RATE_MODE_RX
		self.i_ch1_ffc_rrst           = Signal()   # RX Digital logic reset                                          # i_CH1_FFC_RRST
		self.i_ch1_ffc_rx_gear_mode   = Signal()   # RX 2:1 gearing mode                                             # i_CH1_FFC_RX_GEAR_MODE
		self.i_ch1_ffc_rxpwdnb        = Signal()   # RX power-down                                                   # i_CH1_FFC_RXPWDNB
		self.i_ch1_ffc_sb_inv_rx      = Signal()   # Invert recieived data                                           # i_CH1_FFC_SB_INV_RX
		self.i_ch1_rx_refclk          = Signal()   # RX CDR Reference clock input                                    # i_CH1_RX_REFCLK
		self.o_ch1_ff_rx_d            = Signal(24) # RX FIFO data                                                    # o_CH1_FF_RX_D_0-o_CH1_FF_RX_D_23
		self.o_ch1_ff_rx_f_clk        = Signal()   # Recovered clock from RX CDR                                     # o_CH1_FF_RX_F_CLK
		self.o_ch1_ff_rx_h_clk        = Signal()   # DIV/2 recovered clock from RX CDR                               # o_CH1_FF_RX_H_CLK
		self.o_ch1_ff_rx_pclk         = Signal()   # Recovered RX primary clock (DIV/2 when 2:1 gearing)             # o_CH1_FF_RX_PCLK
		self.o_ch1_ffs_cc_overrun     = Signal()   # RX Clock compensator FIFO overrun error                         # o_CH1_FFS_CC_OVERRUN
		self.o_ch1_ffs_cc_underrun    = Signal()   # RX Clock compensator FIFO underrun error                        # o_CH1_FFS_CC_UNDERRUN
		self.o_ch1_ffs_rlol           = Signal()   # RX CDR loss-of-lock                                             # o_CH1_FFS_RLOL
		self.o_ch1_ffs_rlos           = Signal()   # RX Loss-of-signal                                               # o_CH1_FFS_RLOS
		self.o_ch1_ffs_rxfbfifo_error = Signal()   # RX FPBA bridge FIFO error                                       # o_CH1_FFS_RXFBFIFO_ERROR
		self.o_ch1_ldr_rx2core        = Signal()   # Single-ended low-data-rate output from RX to FPGA fabric        # o_CH1_LDR_RX2CORE
		self.p_ch1_ff_rx_f_clk_dis    = Const(0)   # Disable `FF_RX_F_CLK`                                           # p_CH1_FF_RX_F_CLK_DIS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_ff_rx_h_clk_en     = Const(0)   # Enable `FF_RX_H_CLK`                                            # p_CH1_FF_RX_H_CLK_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_invert_rx          = Const(0)   # Invert channel RX P/N IO pair                                   # p_CH1_INVERT_RX: "DONTCARE" "0b0" "0b1"
		self.p_ch1_ldr_rx2core_sel    = Const(0)   # Enable RX out-of-band input from SerDes boundary scan           # p_CH1_LDR_RX2CORE_SEL: "DONTCARE" "0b0" "0b1"
		self.p_ch1_leq_offset_sel     = Const(0)   # RX common-mode DC voltage offset cancellation (n-side;p-side)   # p_CH1_LEQ_OFFSET_SEL: "DONTCARE" "0b0" "0b1"
		self.p_ch1_leq_offset_trim    = Const(0)   # RX offset cancellation current trim (tbd)                       # p_CH1_LEQ_OFFSET_TRIM: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_rate_mode_rx       = Const(0)   # Default RX data-rate div/2 mode                                 # p_CH1_RATE_MODE_RX: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rcv_dcc_en         = Const(0)   # RC DC coupling                                                  # p_CH1_RCV_DCC_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_req_en             = Const(0)   # Enable RX equalization                                          # p_CH1_REQ_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_req_lvl_set        = Const(0)   # RX equalization level (6bB;9dB;12dB)                            # p_CH1_REQ_LVL_SET: "DONTCARE" "0b00" "0b11"
		self.p_ch1_rlos_sel           = Const(0)   # Set RX Loss-of-signal output to control the CDR phase-detector  # p_CH1_RLOS_SEL: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rterm_rx           = Const(0)   # Input Termination (0:5k;6:75;11:60;22:50)                       # p_CH1_RTERM_RX: "DONTCARE" "0d0"-"0d31"
		self.p_ch1_rx_dco_ck_div      = Const(0)   # RX VCO Divider (00x:1;01x:2;100:4;101:8;110:16;111:32)          # p_CH1_RX_DCO_CK_DIV: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_rx_div11_sel       = Const(0)   # Enable RX Divide-by-11 (standard SMPTE)                         # p_CH1_RX_DIV11_SEL: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rx_gear_bypass     = Const(0)   # Bypass RX gearbox                                               # p_CH1_RX_GEAR_BYPASS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rx_gear_mode       = Const(0)   # Default 2:1 RX gearing mode                                     # p_CH1_RX_GEAR_MODE: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rx_los_ceq         = Const(0)   # RX equialization value at Loss-of-signal detector input         # p_CH1_RX_LOS_CEQ: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_rx_los_en          = Const(0)   # Enable RX Loss-of-signal detection                              # p_CH1_RX_LOS_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rx_los_hyst_en     = Const(0)   # Enable RX Loss-of-signal hysterisis in threshold level          # p_CH1_RX_LOS_HYST_EN: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rx_los_lvl         = Const(0)   # RX Loss-of-signal threshold in mV (30;50;70;90;120;140;160;180) # p_CH1_RX_LOS_LVL: "DONTCARE" "0b000"-"0b111"
		self.p_ch1_rx_rate_sel        = Const(0)   # RX equalizer pole position (high;med;low)                       # p_CH1_RX_RATE_SEL: "DONTCARE" "0d0"-"0d15"
		self.p_ch1_rx_sb_bypass       = Const(0)   # Bypass SerDes RX bridge (actually needed to invert RX?)         # p_CH1_RX_SB_BYPASS: "DONTCARE" "0b0" "0b1"
		self.p_ch1_rxin_cm            = Const(0)   # RX common-mode voltage for equalizer input in AC mode (0v8)     # p_CH1_RXIN_CM: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_rxterm_cm          = Const(0)   # RX common-mode voltage (supply;floating;0v;0v)                  # p_CH1_RXTERM_CM: "DONTCARE" "0b00"-"0b11"
		self.p_ch1_sel_sd_rx_clk      = Const(0)   # RX fb_clk source CDR/FIFO clock selection ('0b1' iff usng CTC)  # p_CH1_SEL_SD_RX_CLK: "DONTCARE" "0b0" "0b1"
