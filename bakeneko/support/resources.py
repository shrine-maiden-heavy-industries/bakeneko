...
# NOTE(aki):
# This is a modified version of the `PCIeBusResources` in the git main for Torii, as it's not released
# yet we have our own copy, and once Torii v1.0.0 drops we can get rid of this
