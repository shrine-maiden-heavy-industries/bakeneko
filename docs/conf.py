...
from bakeneko  import __version__ as bakeneko_version

ROOT_DIR = (Path(__file__).parent).parent

project   = 'Bakeneko'
version   = bakeneko_version
...
extlinks = {
	...
	'bakeneko-issue': ('https://github.com/shrine-maiden-heavy-industries/bakeneko/issues/%s', 'bakeneko/%s'),
...
html_baseurl     = 'https://bakeneko.shmdn.link/'
html_theme       = 'furo'
html_copy_source = False

html_theme_options = {
	'announcement': 'This documentation is a work in progress, and you can help us <a href="https://github.com/shrine-maiden-heavy-industries/bakeneko/blob/main/CONTRIBUTING.md">improve it!</a>', # noqa: E501
	'light_css_variables': {
	...
	'source_repository': 'https://github.com/shrine-maiden-heavy-industries/bakeneko/',
	'source_branch': 'main',
